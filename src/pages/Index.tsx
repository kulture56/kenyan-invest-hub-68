...
const examplePosts = [
  ...
  },
  {
    id: "example-tiktok",
    user_id: "user13",
    content: "Check out this cool personal finance tip from TikTok! #MoneyMatters",
    topic: "Technology",
    ...
    shares: 3,
    reposts: 1,
    author_name: "Kevin Otieno",
    author_username: "kotieno",
    author_avatar: "/placeholder.svg",
    is_verified: false,
    image_url: "",
    mediaUrl: "https://www.tiktok.com/@fincoach/video/7354241048539163906",
    mediaType: "tiktok"
  },
  {
    id: "example-instagram",
    user_id: "user14",
    content: "Saw this helpful infographic about compound interest on Instagram. Worth sharing!",
    topic: "Funds",
    ...
    shares: 2,
    reposts: 0,
    author_name: "Imani Ndungu",
    author_username: "imani",
    author_avatar: "/placeholder.svg",
    is_verified: false,
    image_url: "/lovable-uploads/de5c5024-d2c5-453b-805a-28e479a06fd5.png"
  },
  {
    id: "example-x-twitter",
    user_id: "user15",
    content: "Latest market reaction to interest rates per this X update screenshot.",
    topic: "Market Analysis",
    timestamp: new Date(Date.now() - 4600000).toISOString(),
    created_at: new Date(Date.now() - 4600000).toISOString(),
    updated_at: new Date(Date.now() - 4600000).toISOString(),
    likes: 14,
    comments: 4,
    shares: 1,
    reposts: 0,
    author_name: "Tony Kilonzo",
    author_username: "tkilonzo",
    author_avatar: "/placeholder.svg",
    is_verified: false,
    image_url: "/lovable-uploads/602cec52-f456-44c8-9fef-dc523c21efed.png"
  },
  {
    id: "example-youtube",
    user_id: "user16",
    content: "Great explainer on budgeting basics from YouTube. Highly recommended for beginners.",
    ...
    shares: 4,
    reposts: 1,
    author_name: "Faith Njoki",
    author_username: "faithnjoki",
    author_avatar: "/placeholder.svg",
    is_verified: true,
    image_url: "",
    mediaUrl: "https://www.youtube.com/watch?v=PXgREyFg4t0",
    mediaType: "youtube"
  }
];
