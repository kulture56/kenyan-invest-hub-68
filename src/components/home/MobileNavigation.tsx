...
import { TrendingUp, MessageSquare, Bell, User } from "lucide-react";
...
const MobileNavigation: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border z-40 px-1 py-1">
      <div className="flex justify-around items-center">
        <Button 
          variant="ghost" 
          size="sm" 
          className="flex flex-col gap-0.5 h-12 w-14"
          onClick={() => navigate('/')}
        >
          <img src="/lovable-uploads/e091aef6-fef0-48e9-a419-ef485d7a1022.png" alt="Home" className="h-5 w-5" />
        ...
        >
          <img src="/lovable-uploads/26c24d08-87aa-43d2-8154-2b3715c6cfa4.png" alt="Rafiki" className="h-5 w-5" />
