...
const individualLeaderboard = [
  { id: 1, position: 1, username: "JaneInvestor", avatar: "/placeholder.svg", points: 892 },
  { id: 2, position: 2, username: "InvestKing", avatar: "/placeholder.svg", points: 756 },
  { id: 3, position: 3, username: "MoneyMaker", avatar: "/placeholder.svg", points: 701 },
  { id: 4, position: 4, username: "FinanceGuru", avatar: "/placeholder.svg", points: 645 },
  { id: 5, position: 5, username: "StockWhiz", avatar: "/placeholder.svg", points: 590 }
];

const institutionLeaderboard = [
  { id: 1, position: 1, name: "Equity Bank", avatar: "/placeholder.svg", points: 1245 },
  { id: 2, position: 2, name: "KCB Group", avatar: "/placeholder.svg", points: 1120 },
  { id: 3, position: 3, name: "CIC Insurance", avatar: "/placeholder.svg", points: 986 },
  { id: 4, position: 4, name: "Safaricom", avatar: "/placeholder.svg", points: 845 },
  { id: 5, position: 5, name: "Co-op Bank", avatar: "/placeholder.svg", points: 790 }
];

// Mock data for monthly progress
const monthlyProgress = [
  { month: "Jan", points: 420, totalDays: 31, streakDays: 28 },
  { month: "Feb", points: 380, totalDays: 29, streakDays: 25 },
  { month: "Mar", points: 520, totalDays: 31, streakDays: 30 },
  { month: "Apr", points: 490, totalDays: 30, streakDays: 22 },
  { month: "May", points: 310, totalDays: 31, streakDays: 18 },
  { month: "Jun", points: 210, totalDays: 30, streakDays: 12 }
];
...
const dailyQuestions = [
  { id: 1, text: "What is the current Treasury Bill rate in Kenya?", completed: true },
  { id: 2, text: "Which stock had the highest gain on NSE yesterday?", completed: true },
  { id: 3, text: "What's the recommended minimum emergency fund size?", completed: false },
  { id: 4, text: "What is the current inflation rate in Kenya?", completed: false }
];

// Mock group streaks
const groupStreaks = [
  { id: 1, name: "Investment Club", members: 8, streak: 14 },
  { id: 2, name: "Finance Buddies", members: 5, streak: 7 }
];
                    ...
                    <div className="grid gap-2">
                      ...
                      <div className="flex gap-2">
                        <Button 
                          ...
                          onClick={() => handleShareInvite("message")}
                        >
                        ...
                        <Button 
                          ...
                          variant="outline" 
                          className="flex-1 text-primary"
                          onClick={() => handleShareInvite("post")}
                        >
                  ...
                  return (
                    <div 
                      ...
                      className={`w-full aspect-square rounded-sm ${
                        ...
                        status === "missed" ? "bg-red-500" : "bg-muted"
                      }`}
                      title={`Day ${i+1}: ${
                  ...
                  {monthlyProgress.map(month => (
                    <div 
                      ...
                      className={`p-2 rounded-md border text-center ${
                        month.month === currentMonth ? 'border-primary bg-primary/5' : 'border-muted'
                      }`}
                    >
...
// Missing Trophy icon that was used in the component
