      ...
      <CardContent>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary">{questionsCompleted}/{maxQuestions}</Badge>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            Complete {maxQuestions - questionsCompleted} more questions to earn {(maxQuestions - questionsCompleted) * pointsPerQuestion} points
          </p>
        </div>
      </CardContent>
    </Card>
        ...
        {themedStreaks.length > 0 ? (
          <div className="space-y-3">
            {themedStreaks.map((streak) => (
              <div key={streak.id} className="p-3 border rounded-lg">
          ...
          <p className="text-muted-foreground">No active themed streaks</p>
        )}
      </CardContent>
    </Card>
  );
